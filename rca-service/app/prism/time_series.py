"""Copied verbatim from `ArthurrMrv/automated_root_cause_analysis` (`RCAEval/io/time_series.py`).

This is the preprocessing PRISM calls, vendored unchanged so the ranking here is bit-for-bit the
ranking the offline study produces. Not edited, ever: fix it upstream and re-copy.
"""
